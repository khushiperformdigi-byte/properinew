...
export default function BorrowPage({ onNavigateHome, onNavigatePage }) {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8FD] font-sans text-[#1E1B2E] antialiased selection:bg-purple-100 selection:text-[#7C1FA8] overflow-x-hidden">
      ...
      <section className="w-full bg-[#FAF8FC] bg-gradient-to-r from-[#FAF8FC] via-[#F5EEFC] to-[#FAF8FC] relative overflow-hidden border-b border-[#EBE8EF]/60 -mt-[76px] lg:-mt-[88px] pt-[116px] sm:pt-[126px] lg:pt-[136px] pb-6 sm:pb-7 lg:pb-8 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <section className="py-8 lg:py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto font-sans border-b border-purple-100/60">
        ...
        {/* 4 Cards Grid (2-column on mobile, 4 on desktop) */}
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-5">
            ...
            <div 
              ...
              className="group bg-white hover:bg-[#7C1FA8] hover:border-[#7C1FA8] p-3.5 sm:p-6 rounded-xl sm:rounded-2xl border border-purple-100/90 shadow-2xs hover:shadow-xl hover:scale-[1.02] transition-all cursor-pointer flex flex-col justify-between"
            >
              <div>
                <div className="w-full h-32 sm:h-40 rounded-xl bg-[#FAF6FC] group-hover:bg-white/10 overflow-hidden mb-2.5 sm:mb-3.5 flex items-center justify-center p-1.5 sm:p-2 transition-colors">
                  <img 
                ...
                <h3 className="text-sm sm:text-xl font-extrabold text-[#1E1B2E] group-hover:text-white transition-colors mb-1 sm:mb-2 leading-tight">
                  Personal Loan
                </h3>
                <p className="text-[11px] sm:text-sm text-[#666077] group-hover:text-purple-100/90 leading-normal sm:leading-relaxed font-medium transition-colors">
            ...
            >
              <div>
                ...
                <p className="text-[11px] sm:text-sm text-[#666077] group-hover:text-purple-100/90 leading-normal sm:leading-relaxed font-medium transition-colors">
                  Turn your dream home into reality with flexible options &amp; low interest.
                </p>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <p className="text-[11px] sm:text-sm text-[#666077] group-hover:text-purple-100/90 leading-normal sm:leading-relaxed font-medium transition-colors">
                  Fuel your business growth with working capital &amp; equipment loans.
                </p>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <p className="text-[11px] sm:text-sm text-[#666077] group-hover:text-purple-100/90 leading-normal sm:leading-relaxed font-medium transition-colors">
                  Get quick funds by leveraging investments, without selling them.
                </p>
              </div>
            </div>
