...
export default function ToolsPage({ onNavigateHome, onNavigatePage }) {
  ...
  return (
    <div className="w-full bg-[#FAF8FC] font-sans text-[#1E1B2E] antialiased selection:bg-purple-100 selection:text-[#7C1FAB] overflow-x-hidden">
      ...
      {/* 3. HERO SECTION BANNER - SMART TOOLS, BETTER DECISIONS */}
      <section className="w-full bg-[#FAF8FC] bg-gradient-to-r from-[#FAF8FC] via-[#F5EEFC] to-[#FAF8FC] relative overflow-hidden border-b border-[#EBE8EF]/60 -mt-[88px] lg:-mt-[104px] pt-[130px] sm:pt-[145px] lg:pt-[160px] pb-4 sm:pb-6 lg:pb-7 px-4 sm:px-6 lg:px-8 font-sans">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center relative z-10">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center items-start text-left relative py-2 space-y-4">
            ...
            {/* Category Pill Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-100/90 border border-purple-200/80 text-[#7C1FA8] text-xs font-black uppercase tracking-wider shadow-2xs">
              <span className="w-2 h-2 rounded-full bg-[#7C1FA8] inline-block animate-pulse"></span>
              <span>SMART TOOLS, BETTER DECISIONS</span>
            </div>

            {/* Main Title */}
            <h1 className="font-sans font-extrabold text-[32px] leading-[40px] sm:text-[42px] sm:leading-[50px] lg:text-[46px] lg:leading-[54px] tracking-[-0.03em] text-[#1E1B2E] max-w-[620px]">
              Calculate today. <br />
              Plan better <span className="text-[#7C1FA8]">tomorrow.</span>
            </h1>

            {/* Subtitle Paragraph */}
            <p className="font-medium text-[14px] sm:text-[15.5px] leading-[22px] sm:leading-[26px] text-[#544F66] max-w-[580px]">
              Empower your wealth journey with PROSPERi5's suite of interactive calculators. Estimate SIP compounding returns, loan EMIs, term insurance coverage, and instant credit limits against securities with real-time accuracy.
            </p>

            {/* Key Benefit Highlights List */}
            <div className="flex flex-wrap items-center gap-2.5 pt-0.5">
              <div className="flex items-center gap-1.5 bg-white/90 border border-purple-100 px-3 py-1 rounded-full text-xs font-bold text-[#1E1B2E] shadow-2xs">
                <span className="text-[#7C1FA8]">⚡</span> Real-time Compounding Projections
              </div>
              <div className="flex items-center gap-1.5 bg-white/90 border border-purple-100 px-3 py-1 rounded-full text-xs font-bold text-[#1E1B2E] shadow-2xs">
                <span className="text-emerald-600">🛡️</span> Zero Equity Liquidation Estimates
              </div>
              <div className="flex items-center gap-1.5 bg-white/90 border border-purple-100 px-3 py-1 rounded-full text-xs font-bold text-[#1E1B2E] shadow-2xs">
                <span className="text-purple-600">📊</span> Multi-Asset Allocation Tools
              </div>
            </div>

            {/* 4 Feature Highlight Cards Row */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 w-full pt-1">
              
              {/* Feature 1: Instant Results */}
              <div className="flex items-center gap-2.5 bg-white/80 backdrop-blur-xs p-2.5 rounded-2xl border border-purple-100/80 shadow-2xs">
                <div className="w-9 h-9 rounded-xl bg-[#7C1FA8] text-white flex items-center justify-center shrink-0">
                  <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div className="text-left overflow-hidden">
                  <div className="text-xs font-bold text-[#1E1B2E] truncate">Instant Results</div>
                  <div className="text-[10.5px] text-[#666077] font-medium truncate">Real-time calculations</div>
                </div>
              </div>

              {/* Feature 2: 100% Accurate */}
              <div className="flex items-center gap-2.5 bg-white/80 backdrop-blur-xs p-2.5 rounded-2xl border border-purple-100/80 shadow-2xs">
                <div className="w-9 h-9 rounded-xl bg-[#E01E5A] text-white flex items-center justify-center shrink-0">
                  <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <div className="text-left overflow-hidden">
                  <div className="text-xs font-bold text-[#1E1B2E] truncate">100% Accurate</div>
                  <div className="text-[10.5px] text-[#666077] font-medium truncate">Reliable & precise</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5 bg-white/80 backdrop-blur-xs p-2.5 rounded-2xl border border-purple-100/80 shadow-2xs">
                ...
                <div className="text-left overflow-hidden">
                  <div className="text-xs font-bold text-[#1E1B2E] truncate">Private & Secure</div>
                  <div className="text-[10.5px] text-[#666077] font-medium truncate">Your data is safe</div>
                </div>
              </div>

              {/* Feature 4: Easy to Use */}
              <div className="flex items-center gap-2.5 bg-white/80 backdrop-blur-xs p-2.5 rounded-2xl border border-purple-100/80 shadow-2xs">
                <div className="w-9 h-9 rounded-xl bg-[#27AE60] text-white flex items-center justify-center shrink-0">
                  <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                  </svg>
                </div>
                <div className="text-left overflow-hidden">
                  <div className="text-xs font-bold text-[#1E1B2E] truncate">Easy to Use</div>
                  <div className="text-[10.5px] text-[#666077] font-medium truncate">Simple & intuitive</div>
                </div>
              </div>
          ...
          {/* RIGHT COLUMN: 3D Calculator Illustration */}
          <div className="lg:col-span-6 relative flex items-center justify-center lg:justify-end w-full h-full mt-4 lg:mt-0">
            <div className="relative z-10 w-full h-full flex justify-center lg:justify-end items-center">
              <img
                src="/ChatGPT Image Aug 29, 2026, 11_44_58 PM.png"
                alt="Calculate today. Plan better tomorrow. - Smart Tools by PROSPERi5"
                className="w-full h-auto max-h-[380px] sm:max-h-[440px] lg:max-h-[460px] max-w-[620px] object-contain drop-shadow-xl select-none pointer-events-none"
                draggable={false}
              />
            </div>
          </div>
      ...
      <section className="w-full py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-[#FAF8FC] relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          {/* 4 Premium Cards Grid (2-column on mobile, 2 on desktop) */}
          <div className="grid grid-cols-2 lg:grid-cols-2 gap-3.5 sm:gap-8">

            {/* CARD 1: SIP CALCULATOR */}
            <div className="bg-white rounded-[20px] sm:rounded-[32px] border border-[#EBE3F5] p-3.5 sm:p-8 lg:p-9 shadow-[0_8px_30px_rgba(30,27,46,0.04)] hover:shadow-[0_20px_45px_rgba(124,31,171,0.09)] transition-all duration-300 flex flex-col justify-between group hover:border-[#D8B4FE]/80 relative overflow-hidden">

              <div className="flex flex-col sm:flex-row items-stretch sm:items-start justify-between gap-3 sm:gap-6 h-full">

                {/* Top/Right 3D Graphic (Rendered first on mobile at top, right on desktop) */}
                <div className="order-1 sm:order-2 w-full sm:w-[210px] md:w-[240px] h-[95px] sm:h-[220px] flex items-center justify-center shrink-0 relative mb-1 sm:mb-0 sm:mt-0">
                  <div className="absolute inset-0 bg-purple-100/30 rounded-full blur-xl sm:blur-2xl group-hover:bg-purple-200/40 transition-colors pointer-events-none"></div>
                  <img
                    src="/tools_card_sip.png"
                    alt="SIP Calculator 3D Illustration"
                    className="max-h-[90px] sm:max-h-[220px] w-auto object-contain select-none group-hover:scale-105 transition-transform duration-300 relative z-10"
                  />
                </div>

                {/* Bottom/Left Text Block (Rendered second on mobile at bottom, left on desktop) */}
                <div className="order-2 sm:order-1 flex-1 space-y-2 sm:space-y-4 text-left flex flex-col justify-between">

                  <div className="space-y-2 sm:space-y-4">
                    {/* Badge & Title */}
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full bg-[#F5EEFB] text-[#7C1FAB] flex items-center justify-center font-bold text-xs sm:text-lg shrink-0 group-hover:scale-110 group-hover:bg-[#7C1FAB] group-hover:text-white transition-all">
                      ...
                      <h3 className="text-xs sm:text-[22px] font-bold text-[#1E1B2E] leading-tight">
                        SIP Calculator
                      </h3>
                    </div>

                    {/* Description */}
                    <p className="text-[10.5px] sm:text-sm text-[#544F66] font-medium leading-tight sm:leading-relaxed">
                      Plan investments &amp; build wealth with small steps.
                    </p>

                    {/* Checklist (Hidden on mobile for compactness) */}
                  ...
                  <div className="pt-1.5 sm:pt-3">
                    <button
                      ...
                      className="inline-flex items-center gap-1 sm:gap-2 border border-[#7C1FAB]/30 text-[#7C1FAB] hover:bg-[#7C1FAB] hover:text-white rounded-lg sm:rounded-[14px] px-3 sm:px-5 py-1.5 sm:py-2.5 font-bold text-[10.5px] sm:text-xs transition-all duration-300 shadow-xs sm:shadow-sm cursor-pointer group-hover:border-[#7C1FAB]"
                    >
                      <span>Calculate SIP</span>
                      <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
            ...
            <div className="bg-white rounded-[20px] sm:rounded-[32px] border border-[#EBE3F5] p-3.5 sm:p-8 lg:p-9 shadow-[0_8px_30px_rgba(30,27,46,0.04)] hover:shadow-[0_20px_45px_rgba(200,30,140,0.09)] transition-all duration-300 flex flex-col justify-between group hover:border-[#FBCFE8]/90 relative overflow-hidden">

              <div className="flex flex-col sm:flex-row items-stretch sm:items-start justify-between gap-3 sm:gap-6 h-full">

                {/* Top/Right 3D Graphic */}
                <div className="order-1 sm:order-2 w-full sm:w-[210px] md:w-[240px] h-[95px] sm:h-[220px] flex items-center justify-center shrink-0 relative mb-1 sm:mb-0 sm:mt-0">
                  <div className="absolute inset-0 bg-pink-100/30 rounded-full blur-xl sm:blur-2xl group-hover:bg-pink-200/40 transition-colors pointer-events-none"></div>
                  <img
                ...
                <div className="order-2 sm:order-1 flex-1 space-y-2 sm:space-y-4 text-left flex flex-col justify-between">
                  ...
                  <div className="space-y-2 sm:space-y-4">
                    {/* Badge & Title */}
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full bg-[#FCEBF4] text-[#C81E8C] flex items-center justify-center font-bold text-xs sm:text-lg shrink-0 group-hover:scale-110 group-hover:bg-[#C81E8C] group-hover:text-white transition-all">
                        <svg className="w-3.5 h-3.5 sm:w-5 sm:h-5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                    ...
                    {/* Description */}
                    <p className="text-[10.5px] sm:text-sm text-[#544F66] font-medium leading-tight sm:leading-relaxed">
                      Calculate loan EMIs &amp; plan repayments better.
                    </p>
                  ...
                  <div className="pt-1.5 sm:pt-3">
                    <button
                      ...
                      className="inline-flex items-center gap-1 sm:gap-2 border border-[#C81E8C]/30 text-[#C81E8C] hover:bg-[#C81E8C] hover:text-white rounded-lg sm:rounded-[14px] px-3 sm:px-5 py-1.5 sm:py-2.5 font-bold text-[10.5px] sm:text-xs transition-all duration-300 shadow-xs sm:shadow-sm cursor-pointer group-hover:border-[#C81E8C]"
                    >
            ...
            <div className="bg-white rounded-[20px] sm:rounded-[32px] border border-[#EBE3F5] p-3.5 sm:p-8 lg:p-9 shadow-[0_8px_30px_rgba(30,27,46,0.04)] hover:shadow-[0_20px_45px_rgba(245,166,35,0.09)] transition-all duration-300 flex flex-col justify-between group hover:border-[#FED7AA]/90 relative overflow-hidden">

              <div className="flex flex-col sm:flex-row items-stretch sm:items-start justify-between gap-3 sm:gap-6 h-full">

                {/* Top/Right 3D Graphic */}
                <div className="order-1 sm:order-2 w-full sm:w-[210px] md:w-[240px] h-[95px] sm:h-[220px] flex items-center justify-center shrink-0 relative mb-1 sm:mb-0 sm:mt-0">
                  <div className="absolute inset-0 bg-amber-100/30 rounded-full blur-xl sm:blur-2xl group-hover:bg-amber-200/40 transition-colors pointer-events-none"></div>
                  <img
                ...
                <div className="order-2 sm:order-1 flex-1 space-y-2 sm:space-y-4 text-left flex flex-col justify-between">
                  ...
                  <div className="space-y-2 sm:space-y-4">
                    {/* Badge & Title */}
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full bg-[#FFF4DE] text-[#EA580C] flex items-center justify-center font-bold text-xs sm:text-lg shrink-0 group-hover:scale-110 group-hover:bg-[#EA580C] group-hover:text-white transition-all">
                        <svg className="w-3.5 h-3.5 sm:w-5 sm:h-5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                        </svg>
                      </div>
                    ...
                    {/* Description */}
                    <p className="text-[10.5px] sm:text-sm text-[#544F66] font-medium leading-tight sm:leading-relaxed">
                      Find the right term insurance cover for your family.
                    </p>
                  ...
                  <div className="pt-1.5 sm:pt-3">
                    <button
                      ...
                      className="inline-flex items-center gap-1 sm:gap-2 border border-[#EA580C]/30 text-[#EA580C] hover:bg-[#EA580C] hover:text-white rounded-lg sm:rounded-[14px] px-3 sm:px-5 py-1.5 sm:py-2.5 font-bold text-[10.5px] sm:text-xs transition-all duration-300 shadow-xs sm:shadow-sm cursor-pointer group-hover:border-[#EA580C]"
                    >
                      <span>Calculate Cover</span>
                      <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                      </svg>
                    </button>
            ...
            <div className="bg-white rounded-[20px] sm:rounded-[32px] border border-[#EBE3F5] p-3.5 sm:p-8 lg:p-9 shadow-[0_8px_30px_rgba(30,27,46,0.04)] hover:shadow-[0_20px_45px_rgba(22,163,74,0.09)] transition-all duration-300 flex flex-col justify-between group hover:border-[#BBF7D0]/90 relative overflow-hidden">

              <div className="flex flex-col sm:flex-row items-stretch sm:items-start justify-between gap-3 sm:gap-6 h-full">

                {/* Top/Right 3D Graphic */}
                <div className="order-1 sm:order-2 w-full sm:w-[210px] md:w-[240px] h-[95px] sm:h-[220px] flex items-center justify-center shrink-0 relative mb-1 sm:mb-0 sm:mt-0">
                  <div className="absolute inset-0 bg-emerald-100/30 rounded-full blur-xl sm:blur-2xl group-hover:bg-emerald-200/40 transition-colors pointer-events-none"></div>
                  <img
                ...
                <div className="order-2 sm:order-1 flex-1 space-y-2 sm:space-y-4 text-left flex flex-col justify-between">
                  ...
                  <div className="space-y-2 sm:space-y-4">
                    {/* Badge & Title */}
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full bg-[#ECFDF5] text-[#16A34A] flex items-center justify-center font-bold text-xs sm:text-lg shrink-0 group-hover:scale-110 group-hover:bg-[#16A34A] group-hover:text-white transition-all">
                        <svg className="w-3.5 h-3.5 sm:w-5 sm:h-5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                        </svg>
                      </div>
                    ...
                    {/* Description */}
                    <p className="text-[10.5px] sm:text-sm text-[#544F66] font-medium leading-tight sm:leading-relaxed">
                      Unlock the value of your investments for quick loans.
                    </p>
                  ...
                  <div className="pt-1.5 sm:pt-3">
                    <button
                      ...
                      className="inline-flex items-center gap-1 sm:gap-2 border border-[#16A34A]/30 text-[#16A34A] hover:bg-[#16A34A] hover:text-white rounded-lg sm:rounded-[14px] px-3 sm:px-5 py-1.5 sm:py-2.5 font-bold text-[10.5px] sm:text-xs transition-all duration-300 shadow-xs sm:shadow-sm cursor-pointer group-hover:border-[#16A34A]"
                    >
