        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch relative z-10">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center items-start text-left space-y-4 relative py-2">
            ...
            <h1 className="font-sans font-extrabold text-[36px] leading-[44px] sm:text-[46px] sm:leading-[54px] lg:text-[52px] lg:leading-[60px] tracking-[-0.03em] text-[#1E1B2E] max-w-[600px]">
              ...
              Secure Your <span className="text-[#7C1FA8]">Tomorrow.</span>
            </h1>
          ...
          <div className="lg:col-span-6 relative flex items-center justify-center lg:justify-end w-full h-full mt-4 lg:mt-0">
            <div className="relative z-10 w-full h-full flex justify-center lg:justify-end items-center">
              <img
                src="/ChatGPT Image Aug 29, 2026, 11_29_52 PM.png"
                alt="Calculate. Compare. Secure Your Tomorrow - PROSPERi5 Term Insurance Calculator"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-6 relative z-10">
        ...
        <section className="mt-8 bg-white rounded-[24px] sm:rounded-[28px] border border-[#EBE3F5] p-5 sm:p-7 shadow-[0_8px_30px_rgba(30,27,46,0.04)] text-left">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4">
            ...
            {/* Card 1 */}
            <div className="bg-[#FAF8FC] border border-[#EBE3F5] rounded-xl sm:rounded-2xl p-3 sm:p-4 flex flex-col sm:flex-row items-start gap-2.5 sm:gap-3.5 hover:border-purple-200 transition-colors">
              ...
              <div>
                <h4 className="font-bold text-xs sm:text-sm text-[#1E1B2E] mb-0.5 sm:mb-1 leading-tight">Financial Security</h4>
                <p className="text-[10px] sm:text-[11px] text-[#544F66] leading-tight sm:leading-relaxed">Provides financial support to family.</p>
              </div>
            </div>
            ...
            <div className="bg-[#FAF8FC] border border-[#EBE3F5] rounded-xl sm:rounded-2xl p-3 sm:p-4 flex flex-col sm:flex-row items-start gap-2.5 sm:gap-3.5 hover:border-purple-200 transition-colors">
              ...
              <div>
                <h4 className="font-bold text-xs sm:text-sm text-[#1E1B2E] mb-0.5 sm:mb-1 leading-tight">Affordable Premiums</h4>
                <p className="text-[10px] sm:text-[11px] text-[#544F66] leading-tight sm:leading-relaxed">High coverage at lower cost.</p>
              </div>
            </div>
            ...
            <div className="bg-[#FAF8FC] border border-[#EBE3F5] rounded-xl sm:rounded-2xl p-3 sm:p-4 flex flex-col sm:flex-row items-start gap-2.5 sm:gap-3.5 hover:border-purple-200 transition-colors">
              ...
              <div>
                <h4 className="font-bold text-xs sm:text-sm text-[#1E1B2E] mb-0.5 sm:mb-1 leading-tight">Tax Benefits</h4>
                <p className="text-[10px] sm:text-[11px] text-[#544F66] leading-tight sm:leading-relaxed">Save tax u/s 80C &amp; 10(10D).</p>
              </div>
            </div>
            ...
            <div className="bg-[#FAF8FC] border border-[#EBE3F5] rounded-xl sm:rounded-2xl p-3 sm:p-4 flex flex-col sm:flex-row items-start gap-2.5 sm:gap-3.5 hover:border-purple-200 transition-colors">
              ...
              <div>
                <h4 className="font-bold text-xs sm:text-sm text-[#1E1B2E] mb-0.5 sm:mb-1 leading-tight">Peace of Mind</h4>
                <p className="text-[10px] sm:text-[11px] text-[#544F66] leading-tight sm:leading-relaxed">Secure family's future, always.</p>
              </div>
            </div>
