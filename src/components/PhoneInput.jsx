...
export default function PhoneInput({
  ...
  return (
    <div className={`relative w-full ${className}`} ref={dropdownRef}>
      <div className="flex items-center w-full bg-transparent border-none shadow-none focus-within:outline-none">
        
        {/* Flag Trigger Button (Left Side) */}
        <button
          type="button"
          onClick={() => setIsOpen(!isOpen)}
          className="flex items-center gap-1.5 pr-2.5 py-1 bg-transparent border-r border-[#EBE8EF] hover:opacity-80 transition-colors cursor-pointer shrink-0 select-none"
        ...
        <div className="flex items-center flex-1 pl-2.5 pr-1 py-1">
          ...
          <input
            ...
            pattern="[0-9]*"
            inputMode="numeric"
            placeholder={placeholder || currentCountry.format || 'Enter mobile number'}
