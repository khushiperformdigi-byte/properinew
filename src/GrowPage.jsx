...
export default function GrowPage({ onNavigateHome, onNavigatePage }) {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8FC] font-body text-body-text antialiased selection:bg-purple-100 selection:text-primary-purple overflow-x-hidden">
      ...
      <section className="w-full bg-[#FAF8FC] bg-gradient-to-r from-[#FAF8FC] via-[#F5EEFC] to-[#FAF8FC] border-b border-[#EBE8EF]/60 relative overflow-hidden pt-6 sm:pt-8 lg:pt-10 pb-5 sm:pb-6 lg:pb-7 px-4 sm:px-6 lg:px-8 font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2.5 sm:gap-4 relative z-10">
              ...
              <div className="bg-[#FAF7FD] border border-[#F0E6F7] rounded-xl sm:rounded-2xl p-3 sm:p-4.5 flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3.5">
                <div className="w-8 h-8 sm:w-11 sm:h-11 rounded-lg sm:rounded-xl bg-[#F3E8FF] text-[#7C1FA8] flex items-center justify-center shrink-0">
                  <svg className="w-4 h-4 sm:w-5.5 sm:h-5.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                </div>
                <div>
                  <span className="text-sm sm:text-lg font-extrabold text-[#7C1FA8] block leading-tight whitespace-nowrap">₹10,000 Cr+</span>
                  <span className="text-[11px] sm:text-xs text-[#6E6B7B] font-semibold leading-tight block mt-0.5">Assets on Platform</span>
                </div>
              </div>
              ...
              <div className="bg-[#FAF7FD] border border-[#F0E6F7] rounded-xl sm:rounded-2xl p-3 sm:p-4.5 flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3.5">
                ...
                <div>
                  <span className="text-sm sm:text-lg font-extrabold text-[#7C1FA8] block leading-tight whitespace-nowrap">1M+</span>
                  <span className="text-[11px] sm:text-xs text-[#6E6B7B] font-semibold leading-tight block mt-0.5">Happy Investors</span>
                </div>
              </div>
              ...
              <div className="bg-[#FAF7FD] border border-[#F0E6F7] rounded-xl sm:rounded-2xl p-3 sm:p-4.5 flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3.5">
                ...
                <div>
                  <span className="text-sm sm:text-lg font-extrabold text-[#7C1FA8] block leading-tight whitespace-nowrap">4.8 ★</span>
                  <span className="text-[11px] sm:text-xs text-[#6E6B7B] font-semibold leading-tight block mt-0.5">Average Rating</span>
                </div>
              </div>
              ...
              <div className="bg-[#FAF7FD] border border-[#F0E6F7] rounded-xl sm:rounded-2xl p-3 sm:p-4.5 flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3.5">
                ...
                <div>
                  <span className="text-sm sm:text-lg font-extrabold text-[#7C1FA8] block leading-tight whitespace-nowrap">99.9%</span>
                  <span className="text-[11px] sm:text-xs text-[#6E6B7B] font-semibold leading-tight block mt-0.5">Uptime &amp; Security</span>
                </div>
              </div>
