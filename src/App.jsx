...
function App() {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          setMobilePartnerCardsVisible(true);
        } else if (entry.boundingClientRect.top > 0) {
          // Reset when scrolled back above section so re-scrolling triggers animation
          setMobilePartnerCardsVisible(false);
        }
      },
      { threshold: 0.15 }
    );
  ...
  const renderHomepageSections = () => (
    <>
      ...
      <main className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 -mt-[76px] lg:-mt-[88px] pt-[96px] sm:pt-[126px] lg:pt-[136px] pb-4 lg:pb-8 z-10 relative overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center">
          ...
          <ScrollReveal animation="left" delay={40} className="lg:col-span-6 flex flex-col items-center lg:items-start z-10 max-w-3xl mx-auto lg:mx-0 text-center lg:text-left">
            {/* Hero Main Heading */}
            <h1 className="font-sans text-2xl sm:text-[36px] lg:text-[48px] leading-tight sm:leading-[44px] lg:leading-[54px] font-semibold text-heading-ink text-center lg:text-left tracking-[-0.04em] max-w-[680px]">
              The Multi-Asset Wealth <br className="hidden sm:block" />
              Management Platform <br className="hidden sm:block" />
              for Every Partner
            </h1>

            {/* Underline Split Divider - Mobile Only */}
            <div className="flex items-center justify-center gap-2 w-full max-w-[260px] sm:w-[300px] h-[3px] mt-3 mx-auto lg:hidden">
              <div className="flex-1 h-full bg-[#C81E8C] rounded-full"></div>
              <div className="w-[65px] h-full bg-[#F5A623] rounded-full"></div>
            </div>

            {/* Accent Line - Desktop Only */}
            <div className="hidden lg:flex items-center gap-[5px] w-[340px] h-[3px] mt-3.5">
              <div className="w-[255px] h-full bg-[#C81E8C] rounded-full"></div>
              <div className="w-[80px] h-full bg-[#F5A623] rounded-full"></div>
            </div>

            {/* Hero Subtitle: Desktop */}
            <p
              style={{ fontFamily: "'Inter', sans-serif" }}
              className="font-medium text-[15.5px] leading-[24px] tracking-[-0.5px] text-[#544F66] mt-3.5 text-left lg:block hidden max-w-[510px]"
            >
            ...
            <p
              style={{ fontFamily: "'Inter', sans-serif" }}
              className="font-medium text-xs sm:text-[16px] leading-relaxed tracking-[-0.5px] text-[#544F66] mt-2.5 text-center max-w-[560px] lg:hidden block"
            >
              Join the financial advisors increasing their revenue by offering wealth solution through investment, insurance, and financing solutions to their clients.
            </p>
            ...
            <div className="flex lg:hidden flex-col items-center gap-3 mt-5 select-none w-full max-w-[280px] mx-auto">
              {/* Button 1: Start Growing ↗ */}
              <button onClick={() => navigateToPage('grow')} className="w-full h-[48px] sm:h-[52px] bg-primary-purple hover:bg-deep-purple text-white font-bold rounded-full shadow-md shadow-purple-100 hover:shadow-purple-200 hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center justify-center gap-2 duration-200 cursor-pointer text-xs sm:text-sm">
              ...
              <button onClick={() => navigateToPage('about')} className="w-full h-[48px] sm:h-[52px] border-[1.5px] border-primary-purple text-primary-purple hover:bg-purple-surface/30 font-bold rounded-full bg-white transition-all cursor-pointer text-xs sm:text-sm flex items-center justify-center gap-2">
            ...
            <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 mt-4 justify-center lg:justify-start w-full">
              {/* Google Play Button */}
              <a
                href="#download"
                onClick={(e) => {
                ...
                className="flex items-center gap-2.5 sm:gap-3 bg-[#0D0B18] hover:bg-[#1A182E] border border-white/15 hover:border-[#7C1FA8]/50 text-white rounded-xl px-3.5 py-2 sm:px-4.5 sm:py-2.5 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 group cursor-pointer"
              >
                ...
                <div className="flex flex-col text-left leading-none">
                  <span className="text-[8.5px] sm:text-[10px] font-bold text-gray-300 uppercase tracking-wider mb-0.5">
                    GET IT ON
                  </span>
          ...
          {/* RIGHT HERO VISUAL */}
          <ScrollReveal animation="right" delay={120} className="lg:col-span-6 flex items-center justify-center lg:justify-end w-full pt-1 lg:pt-0 select-none z-10">
            <div className="relative w-full max-w-[560px] sm:max-w-[660px] lg:max-w-[740px] xl:max-w-[780px] aspect-[740/590] flex items-center justify-center mx-auto lg:mr-0">
              
              {/* 1. Bottom Right Background Graph Line (Group 137.png) - Compact Size */}
              <img
                src="/Group 137.png"
                alt="Growth Graph Line"
                className="absolute bottom-0 right-0 w-[38%] sm:w-[35%] max-h-[30%] object-contain object-bottom z-0 pointer-events-none opacity-90"
              />

              {/* 2. Center Advisor Cutout (image 18 (2).png) - Fully Unblocked Suit */}
              <img
                src="/image 18 (2).png"
                alt="PROSPERi5 Financial Advisor"
                className="absolute bottom-[6%] left-1/2 -translate-x-[50%] h-[93%] w-auto object-contain z-20 pointer-events-none filter drop-shadow-xl"
              />

              {/* 3. Top Right Badge (Portfolio Growth.png) - Increased Size Slightly */}
              <img
                src="/Portfolio Growth.png"
                alt="Portfolio Growth"
                className="absolute top-[4.5%] right-[3.5%] z-30 w-[28%] sm:w-[26%] h-auto object-contain filter drop-shadow-md hover:scale-105 transition-transform duration-300 cursor-pointer"
              />

              {/* 4. Right Card 1 (Investments.png) - Micro gap from man */}
              <img
                src="/Investments.png"
                alt="Investments"
                onClick={() => navigateToPage('grow')}
                className="absolute top-[18%] right-[-0.5%] z-30 w-[33.5%] sm:w-[31.5%] h-auto object-contain filter drop-shadow-md hover:scale-105 transition-transform duration-300 cursor-pointer"
              />

              {/* 5. Right Card 2 (Insurance (2).png) - Micro gap from man */}
              <img
                src="/Insurance (2).png"
                alt="Insurance"
                onClick={() => navigateToPage('protect')}
                className="absolute top-[36%] right-[-0.5%] z-30 w-[33.5%] sm:w-[31.5%] h-auto object-contain filter drop-shadow-md hover:scale-105 transition-transform duration-300 cursor-pointer"
              />

              {/* 6. Right Card 3 (Financing (2).png) - Micro gap from man */}
              <img
                src="/Financing (2).png"
                alt="Financing"
                onClick={() => navigateToPage('financing')}
                className="absolute top-[54%] right-[-0.5%] z-30 w-[33.5%] sm:w-[31.5%] h-auto object-contain filter drop-shadow-md hover:scale-105 transition-transform duration-300 cursor-pointer"
              />

              {/* 7. Left Card 1 (Portfolio Overview.png) - Micro gap from man */}
              <img
                src="/Portfolio Overview.png"
                alt="Portfolio Overview"
                onClick={() => navigateToPage('partner')}
                className="absolute top-[26%] left-[-1%] z-10 w-[34.5%] sm:w-[32%] h-auto object-contain filter drop-shadow-md hover:scale-105 transition-transform duration-300 cursor-pointer"
              />

              {/* 8. Left Card 2 (Clients.png) - Micro gap from man */}
              <img
                src="/Clients.png"
                alt="Clients"
                onClick={() => navigateToPage('partner')}
                className="absolute bottom-[21%] left-[1.5%] z-30 w-[27.5%] sm:w-[25.5%] h-auto object-contain filter drop-shadow-md hover:scale-105 transition-transform duration-300 cursor-pointer"
              />

              {/* 9. Bottom Center Badge (Advisor Hub.png) - Compact Width */}
              <img
                src="/Advisor Hub.png"
                alt="Grow Your Advisory"
                onClick={() => navigateToPage('partner')}
                className="absolute bottom-[0%] left-1/2 -translate-x-1/2 z-40 w-[42%] sm:w-[39%] h-auto object-contain filter drop-shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer"
              />

            </div>
          </ScrollReveal>

          {/* Mobile Value bullets */}
          <ScrollReveal animation="up" delay={80} className="flex lg:hidden flex-wrap items-center justify-center gap-x-3 gap-y-1 mt-1 mb-2 text-[10px] sm:text-[11px] font-medium text-[#1E1B2E] tracking-[0.002em] w-full mx-auto">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 items-stretch">
            ...
            <ScrollReveal animation="up" delay={50} className="col-span-1 h-full">
              <div
                style={{
                  background: 'linear-gradient(135deg, #461065 0%, #2E0A44 100%)'
                }}
                className="w-full h-full rounded-[24px] p-6 flex flex-col justify-between transition-all duration-300 min-h-[240px] sm:min-h-[265px] lg:min-h-[280px] relative overflow-hidden border border-white/10 text-white shadow-md"
              >
                <div>
                  <h3 className="font-extrabold text-3xl sm:text-4xl font-display tracking-tight leading-none text-white">
                    Up to 30%
                  </h3>
                  <p className="text-white/90 text-xs sm:text-sm font-medium font-sans mt-1.5">
                    More revenue potential
                  </p>
                  <div className="w-9 h-1 bg-white/80 rounded-full mt-2.5"></div>
                </div>

                <div className="w-full flex justify-center items-center mt-auto pt-1">
                  <img src="/image 11.png" className="w-[110px] h-[110px] sm:w-[130px] sm:h-[130px] object-contain filter drop-shadow-md" alt="Up to 30% graphic" />
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal animation="up" delay={120} className="col-span-1 h-full">
              ...
              >
                ...
                <div className="w-full flex justify-center items-center mt-auto pt-1">
                  <img src="/image 10.png" className="w-[110px] h-[110px] sm:w-[130px] sm:h-[130px] object-contain filter drop-shadow-md" alt="50+ Financial products" />
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal animation="up" delay={260} className="col-span-1 h-full">
              ...
              >
                ...
                <div className="w-full flex justify-center items-center mt-auto pt-1">
                  <img src="/ChatGPT Image Aug 31, 2026, 03_26_55 PM.png" className="w-[110px] h-[110px] sm:w-[130px] sm:h-[130px] object-contain filter drop-shadow-md" alt="₹0 Joining fee" />
                </div>
              </div>
            </ScrollReveal>
      ...
      {/* 4. PARTNER VALUE AT A GLANCE SECTION - MOBILE ONLY (STICKY SCROLL STACKING CARDS) */}
      <section
        style={{
          backgroundImage: "url('/partner-value-bg.png')",
          backgroundSize: 'cover',
        ...
        className="block md:hidden w-full py-6 px-4 font-sans border-t border-gray-100"
      >
        <div className="w-full max-w-[360px] mx-auto flex flex-col items-center">
          ...
          <div className="w-full flex flex-col gap-5 relative pb-6 select-none">

            {/* Card 1: ₹0 */}
            <div
              className="sticky top-20 z-10 w-full h-[155px] bg-[#FFF4DE] rounded-[22px] p-5 flex justify-between items-center border border-amber-200/60 shadow-lg"
            >
              <div className="flex flex-col justify-center max-w-[180px]">
                <h3 style={{ fontFamily: "'Inter', sans-serif" }} className="text-[#1E1135] font-extrabold text-[32px] leading-none">
                  ₹0
                </h3>
                <p className="text-[#544F66] text-xs font-bold font-sans mt-2 leading-tight">
                  Joining fee & zero platform charges
                </p>
              </div>
              <img
                src="/ChatGPT Image Aug 31, 2026, 03_26_55 PM.png"
                className="w-[85px] h-[85px] object-contain select-none pointer-events-none shrink-0"
                alt="₹0 Joining fee"
              />
            </div>
            ...
            {/* Card 2: Timely */}
            <div
              className="sticky top-24 z-20 w-full h-[155px] bg-[#FCE9F4] rounded-[22px] p-5 flex justify-between items-center border border-pink-200/60 shadow-xl"
            >
              <div className="flex flex-col justify-center max-w-[180px]">
                <h3 style={{ fontFamily: "'Inter', sans-serif" }} className="text-[#1E1135] font-extrabold text-[32px] leading-none">
                  Timely
                ...
                <p className="text-[#544F66] text-xs font-bold font-sans mt-2 leading-tight">
                  Reliable partner payouts & monthly statements
                </p>
              </div>
              <img
                src="/image 13.png"
                className="w-[80px] h-[80px] object-contain select-none pointer-events-none shrink-0"
                alt="Timely payouts"
              />
            </div>
            ...
            {/* Card 3: Up to 30% */}
            <div
              className="sticky top-28 z-30 w-full h-[155px] bg-[#F5EEFB] rounded-[22px] p-5 flex justify-between items-center border border-purple-200/60 shadow-xl"
            >
              <div className="flex flex-col justify-center max-w-[180px]">
                <h3 style={{ fontFamily: "'Inter', sans-serif" }} className="text-[#1E1135] font-extrabold text-[32px] leading-none">
                  Up to 30%
                ...
                <p className="text-[#544F66] text-xs font-bold font-sans mt-2 leading-tight">
                  More revenue potential from clients
                </p>
              </div>
              <img
                src="/image 11 (2).png"
            ...
            <div
              ...
              className="sticky top-32 z-40 w-full h-[155px] rounded-[22px] p-5 flex justify-between items-center border border-white/10 shadow-2xl text-white"
            >
              <div className="flex flex-col justify-center max-w-[180px]">
                <h3 style={{ fontFamily: "'Inter', sans-serif" }} className="text-white font-extrabold text-[32px] leading-none">
                  50+
                </h3>
                <p className="text-white/90 text-xs font-bold font-sans mt-2 leading-tight">
                  Financial products across investments & insurance
                </p>
              </div>
              <img
                src="/image 10.png"
                className="w-[95px] h-[95px] object-contain filter drop-shadow-md select-none pointer-events-none shrink-0"
      ...
      <section ref={ringSectionRef} className="bg-white w-full py-6 lg:py-8 relative overflow-hidden select-none font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
          ...
          <ScrollReveal animation="up" delay={30} className="text-center mb-5 lg:mb-5 w-full max-w-full lg:max-w-5xl mx-auto flex flex-col items-center px-2 sm:px-4 lg:px-0">
            <h2 className="font-sans font-semibold text-xl sm:text-[32px] leading-tight sm:leading-[40px] lg:text-[36px] lg:leading-[44px] tracking-[-0.5px] text-heading-ink text-center max-w-[760px] mx-auto">
              A Complete Financial Ecosystem For Your Clients
            </h2>
            <p
              style={{ fontFamily: "'Inter', sans-serif" }}
              className="font-medium text-xs sm:text-[14px] leading-relaxed lg:text-[16px] lg:leading-[24px] tracking-[-0.5px] text-[#544F66] mt-2 sm:mt-3 text-center max-w-2xl lg:max-w-[750px] mx-auto"
            >
          ...
          {/* Two Column Layout: Arc Visual + Service Cards */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-center">

            {/* LEFT: Arc Donut Visual */}
            <ScrollReveal animation="left" delay={70} className="lg:col-span-6 flex items-center justify-center px-2 sm:px-4">
              <div className="relative w-[320px] h-[320px] sm:w-[400px] sm:h-[400px] lg:w-[440px] lg:h-[440px] flex items-center justify-center mx-auto select-none my-4">

                {/* ROTATING RING CONTAINER (Smooth 360° Ring Rotation) */}
                <div className="absolute inset-0 w-full h-full animate-[spin_30s_linear_infinite]">

                  {/* Master Ring Asset (Group 185.png) */}
                  <img
                    src="/Group 185.png"
                  ...
                  {/* TOP BADGE OVERLAY (Wallet & Cash Icon) */}
                  <div className="absolute top-[9.5%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[23%] h-[23%] bg-white rounded-full border-[2.5px] border-[#F5A623] shadow-md p-1.5 flex items-center justify-center pointer-events-none z-10">
                    <img
                      src="/ring/Group 183.png"
                      className="w-full h-full object-contain animate-[spin_30s_linear_infinite_reverse]"
                      alt="Financing product icon"
                    />
                  </div>

                  {/* BOTTOM-LEFT BADGE OVERLAY (Money Bag & Chart Icon) */}
                  <div className="absolute top-[70.5%] left-[13.5%] -translate-x-1/2 -translate-y-1/2 w-[23%] h-[23%] bg-white rounded-full border-[2.5px] border-[#7C1FA8] shadow-md p-1.5 flex items-center justify-center pointer-events-none z-10">
                    <img
                      src="/ring/Group 184.png"
                      className="w-full h-full object-contain animate-[spin_30s_linear_infinite_reverse]"
                      alt="Investment product icon"
                    />
                  </div>

                  {/* BOTTOM-RIGHT BADGE OVERLAY (Umbrella & Shield Icon) */}
                  <div className="absolute top-[70.5%] left-[86.5%] -translate-x-1/2 -translate-y-1/2 w-[23%] h-[23%] bg-white rounded-full border-[2.5px] border-[#C81E8C] shadow-md p-1.5 flex items-center justify-center pointer-events-none z-10">
                    <img
                      src="/ring/Group 182.png"
                      className="w-full h-full object-contain animate-[spin_30s_linear_infinite_reverse]"
                      alt="Insurance product icon"
                    />
                  </div>

                </div>

                {/* SOLID WHITE CIRCLE MASK (Covers image baked-in text 100%) */}
                <div className="absolute inset-0 m-auto w-[58%] h-[58%] rounded-full bg-white shadow-xs z-10 pointer-events-none"></div>

                {/* STATIONARY CENTER TEXT (Sits inside clean white circle - 100% still & upright) */}
                <div className="absolute inset-0 m-auto w-[58%] h-[58%] flex flex-col items-center justify-center text-center p-2 z-20 pointer-events-none">
                  <span className="text-[#F5A623] font-bold text-[10px] sm:text-[11.5px] tracking-wider uppercase mb-1 font-sans">
                    ONE PLATFORM
                  </span>
                  <h3
                    style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                    className="font-extrabold text-[16.5px] sm:text-[22px] lg:text-[24px] leading-[20.5px] sm:leading-[26px] lg:leading-[29px] tracking-[-0.03em] text-[#1E1135] max-w-[185px] sm:max-w-[230px] my-0.5"
                  >
                    Every Clients Has Different Requirements
                  </h3>
                  <span
                    style={{ fontFamily: "'Inter', sans-serif" }}
                    className="font-medium text-[9px] sm:text-[10.5px] tracking-tight text-[#544F66] mt-0.5 text-center"
                  >
      ...
      <section id="why-us" ref={reasonsRef} className="bg-[#FAF7FC] w-full pt-10 sm:pt-14 lg:pt-16 pb-6 lg:pb-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden select-none border-t border-purple-100/50 font-sans">
        <div className="max-w-4xl lg:max-w-[840px] mx-auto">

          {/* Centered Header: Exact Mobile & Desktop Specs */}
          <ScrollReveal animation="up" delay={30} className="mb-6 sm:mb-8 text-center flex flex-col items-center mx-auto w-[342px] max-w-full lg:w-full lg:max-w-5xl">
          ...
          <div className="relative pl-2 sm:pl-4">
            ...
            <div className="space-y-3 sm:space-y-3.5 lg:space-y-2.5 relative z-10">
              ...
              {[
                ...
                },
                {
                  ...
                  icon: (isHovered) => (
                    <svg
                      className={`w-11 h-11 lg:w-[50px] lg:h-[50px] transition-colors shrink-0 ${isHovered ? 'text-white' : 'text-[#7C1FA8]'}`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
            ...
            <ScrollReveal animation="scale" delay={80} className="mt-8 sm:mt-10 mb-8 sm:mb-12 lg:mb-14 w-full flex justify-center lg:-mx-16 lg:w-[calc(100%+128px)] lg:max-w-[968px] mx-auto">
      ...
      <section id="how-it-works" ref={howItWorksRef} className="hidden lg:block bg-[#F5EEFA] w-full pt-10 sm:pt-14 lg:pt-16 pb-8 lg:pb-10 px-4 sm:px-6 lg:px-8 relative overflow-hidden select-none border-t border-purple-100/50 font-sans">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5 sm:gap-4 relative max-w-6xl mx-auto items-stretch">
            {[
              ...
              },
              {
                ...
                icon: (
                  <svg className="w-14 h-14 stroke-[1.5]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 21h6" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8 3v18" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8 4.5h6.586a1.5 1.5 0 011.06.44l2.415 2.414a1.5 1.5 0 010 2.122l-2.414 2.414a1.5 1.5 0 01-1.06.44H8" />
                  </svg>
                ),
              },
              {
                ...
                icon: (isHovered) => (
                  <div className="relative">
                    ...
                    <svg className={`w-5 h-5 fill-current absolute -top-1 -right-1 transition-colors duration-200 ${isHovered ? 'text-white' : 'text-[#7C1FAB]'}`} viewBox="0 0 20 20">
              ...
              return (
                <ScrollReveal key={index} animation="up" delay={index * 60} className="h-full flex flex-col">
                  <div
                    ...
                    className={`h-full rounded-[22px] p-5 sm:p-5.5 flex flex-col justify-between transition-all duration-300 ease-out cursor-pointer group ${howItWorksVisible
                  ...
                  >
                    ...
                    <div className="flex justify-start items-end mt-4 pt-2">
                ...
                },
                {
                  ...
                  icon: (isActive) => (
                    <div className="relative">
                      ...
                      <svg className={`w-5 h-5 fill-current absolute -top-1 -right-1 transition-colors duration-200 ${isActive ? 'text-white' : 'text-[#7C1FA8]'}`} viewBox="0 0 20 20">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                      </svg>
                    </div>
                  )
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <ScrollReveal animation="scale" delay={60} className="block lg:hidden w-full max-w-[576px] mx-auto mb-6">
            ...
            >
              ...
              <div className="w-[280px] min-w-[280px] h-[271px] shrink-0 snap-center rounded-[16px] bg-[#7C1FA8] text-white border border-purple-900/40 p-5 flex flex-col justify-between shadow-md relative overflow-hidden">
                <div>
                ...
                <div className="flex items-center justify-between border-t border-white/20 pt-4.5 mt-5 pb-1 w-[232px] max-w-full">
                  <div className="flex items-center gap-2.5">
                    <div className="w-[42px] h-[42px] rounded-full bg-[#2A3447] text-white flex items-center justify-center font-extrabold text-base relative shrink-0 border border-white/20 shadow-xs select-none">
                      <span>A</span>
                      <div className="absolute -bottom-0.5 -right-0.5 w-4 h-4 rounded-full bg-[#FF5722] border border-white flex items-center justify-center text-[9px] text-white font-serif font-bold shadow-xs">
                        "
                      </div>
                    </div>
                    <div>
              ...
              <div className="w-[280px] min-w-[280px] h-[271px] shrink-0 snap-center rounded-[16px] bg-white text-heading-ink border border-purple-100/80 p-5 flex flex-col justify-between shadow-sm">
                <div>
                  ...
                  >
                    PROSPERi5 helped me expand my service offering across mutual funds, health insurance, and loan products without complicating my daily advisory process. The platform support and seamless onboarding have allowed me to build deeper trust with my clients while growing my monthly advisory revenue steadily.
                  </p>
                </div>
                <div className="flex items-center justify-between border-t border-gray-100 pt-4.5 mt-5 pb-1 w-[232px] max-w-full">
                  <div className="flex items-center gap-2.5">
                    <div className="w-[42px] h-[42px] rounded-full bg-[#2A3447] text-white flex items-center justify-center font-extrabold text-base relative shrink-0 shadow-xs select-none">
                      <span>K</span>
                      <div className="absolute -bottom-0.5 -right-0.5 w-4 h-4 rounded-full bg-[#FF5722] border border-white flex items-center justify-center text-[9px] text-white font-serif font-bold shadow-xs">
                        "
                      </div>
          ...
          <div className="hidden lg:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4 mb-5 items-start">
            ...
            <ScrollReveal animation="up" delay={50} className="flex flex-col gap-3.5 sm:gap-4">
              ...
              <div className="bg-[#7C1FA8] text-white rounded-[22px] p-5 sm:p-5.5 flex flex-col justify-between min-h-[245px] shadow-lg border border-white/10 relative overflow-hidden group hover:scale-[1.01] transition-all duration-300">
                <div>
                  ...
                  <p className="font-body-spec text-white text-xs sm:text-sm font-medium leading-relaxed">
                    I was earlier only distributing Mutual Funds, but after partnering with PROSPERi5, I've been able to offer many more financial products to my clients. The payout is better and this partnership has given a double boost to my business income.
                  </p>
                </div>
                <div className="flex items-center justify-between border-t border-white/10 pt-3.5 mt-5 font-sans">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8.5 h-8.5 rounded-full bg-[#2A3447] text-white flex items-center justify-center font-extrabold text-xs relative shrink-0 border border-white/20 shadow-xs">
                      <span>A</span>
                    </div>
                    <div>
              ...
              <div className="bg-white text-heading-ink rounded-[20px] p-4 sm:p-4.5 flex flex-col justify-between border border-purple-100/80 shadow-sm hover:shadow-md transition-all duration-300 font-sans">
                <p className="font-body-spec text-heading-ink text-xs sm:text-[13.5px] font-medium leading-relaxed mb-4">
                  PROSPERi5 helped me expand my service offering across mutual funds and insurance, helping me build trust and grow advisory revenue.
                </p>
                <div className="flex items-center justify-between border-t border-purple-100/60 pt-3">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-full bg-[#2A3447] text-white flex items-center justify-center font-extrabold text-xs relative shrink-0 shadow-xs">
                      <span>K</span>
                    </div>
                    <div>
            ...
            <ScrollReveal animation="up" delay={120} className="flex flex-col gap-3.5 sm:gap-4">
              ...
              <div className="bg-white text-heading-ink rounded-[20px] p-4 sm:p-4.5 flex flex-col justify-between border border-purple-100/80 shadow-sm hover:shadow-md transition-all duration-300 font-sans">
                <p className="font-body-spec text-heading-ink text-xs sm:text-[13.5px] font-medium leading-relaxed mb-4">
                  My background was mainly in insurance, with limited experience in investments. With hands-on support from PROSPERi5, I started offering investment products confidently. This helped me earn from new products and improved my overall understanding of investments.
                </p>
                <div className="flex items-center justify-between border-t border-purple-100/60 pt-3">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-full bg-[#2A3447] text-white flex items-center justify-center font-extrabold text-xs relative shrink-0 shadow-xs">
              ...
              <div className="bg-white text-heading-ink rounded-[20px] p-4 sm:p-4.5 flex flex-col justify-between border border-purple-100/80 shadow-sm hover:shadow-md transition-all duration-300 font-sans">
                <p className="font-body-spec text-heading-ink text-xs sm:text-[13.5px] font-medium leading-relaxed mb-4">
                  As a homemaker with basic financial knowledge, PROSPERi5's support helped me start meaningful financial conversations with friends, family, and society members. I guided people towards the right financial products and built a steady, meaningful additional source of income.
                </p>
                <div className="flex items-center justify-between border-t border-purple-100/60 pt-3">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-full bg-[#2A3447] text-white flex items-center justify-center font-extrabold text-xs relative shrink-0 shadow-xs">
                    ...
                    <div>
                      <h4 className="font-display font-bold text-xs sm:text-[13px] text-heading-ink leading-tight">Surbhi S</h4>
                    </div>
                  </div>
            ...
            <ScrollReveal animation="up" delay={190} className="flex flex-col gap-3.5 sm:gap-4">
              ...
              <div className="bg-white text-heading-ink rounded-[20px] p-4 sm:p-4.5 flex flex-col justify-between border border-purple-100/80 shadow-sm hover:shadow-md transition-all duration-300 font-sans">
                <p className="font-body-spec text-heading-ink text-xs sm:text-[13.5px] font-medium leading-relaxed mb-4">
                  PROSPERi5 handles most of the operational work, which has significantly reduced my day-to-day effort. I now spend more time focusing on client servicing and acquiring new clients, helping me grow my advisory business steadily.
                </p>
                <div className="flex items-center justify-between border-t border-purple-100/60 pt-3">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-full bg-[#2A3447] text-white flex items-center justify-center font-extrabold text-xs relative shrink-0 shadow-xs">
              ...
              <div className="bg-[#7C1FA8] text-white rounded-[22px] p-5 sm:p-5.5 flex flex-col justify-between min-h-[245px] shadow-lg border border-white/10 relative overflow-hidden group hover:scale-[1.01] transition-all duration-300">
                <div>
                  ...
                  <div className="text-[#F5A623] text-2.5xl font-serif font-bold leading-none mb-1.5">“</div>
                  <p className="font-body-spec text-white text-xs sm:text-sm font-medium leading-relaxed">
                    The guidance from PROSPERi5 was clear, personal, and seamlessly integrated. Having a single trusted partner for my clients' complete financial journey has boosted my business income.
                  </p>
                </div>
                <div className="flex items-center justify-between border-t border-white/10 pt-3.5 mt-5 font-sans">
                  <div className="flex items-center gap-2.5">
      ...
      <section id="signup" className="bg-[#FAF6FC] w-full py-4 sm:py-5 lg:py-6 px-4 sm:px-6 lg:px-8 relative overflow-hidden select-none border-t border-purple-100/50 font-sans">
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollReveal animation="scale" delay={50} className="block lg:hidden w-[358px] max-w-full mx-auto">
            <div
              style={{
                backgroundImage: "url('/ChatGPT Image Aug 31, 2026, 02_19_57 PM.png')",
                backgroundSize: 'cover',
                backgroundPosition: 'center',
              }}
          ...
          <ScrollReveal animation="scale" delay={60} className="hidden lg:block bg-white rounded-[26px] p-3 sm:p-4.5 border border-purple-100/80 shadow-xl max-w-[1248px] mx-auto">
            <div className="flex flex-col lg:flex-row items-stretch justify-center gap-4 sm:gap-5">
              ...
              <div
                style={{ backgroundImage: "url('/ChatGPT Image Aug 31, 2026, 02_19_57 PM.png')" }}
              ...
              >
                ...
                <div>
                  ...
                  <div className="mb-4">
                    ...
                    <h3
                      style={{ fontFamily: "'Inter', sans-serif" }}
                      className="font-semibold text-[24px] sm:text-[26px] leading-[32px] text-white tracking-normal mb-1"
                    >
                      Start your partner journey
                    </h3>
                    <p
                  ...
                  {/* White Form Card */}
                  <div className="bg-white rounded-[20px] p-3.5 sm:p-4 text-body-text shadow-xl">
